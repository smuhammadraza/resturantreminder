...
class AddResturantViewModel {
    ...
    func addResturant(userID: String, name: String, address: String, phone: String, url: String, notes: String, categories: [String]) {
        FirebaseManager.shared.addRestaurant(userID: userID, name: name, address: address, phone: phone, url: url, notes: notes, categories: categories)
    }
